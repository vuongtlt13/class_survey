    ...
    <div class="content">
        <div class="container">
            <div class="col-sm-offset-1 col-sm-10 primary_content">
                <!-- header -->
                <div class="row">
                    <h2 style="color: #0D47A1;">Danh sách lớp môn học giảng dạy</h2>
                    <br>
                </div>
                <!-- body -->
            @foreach($classes as $class)
                <!-- a subject -->
                    <div class="item_subject col-sm-8">
                        <div class="col-sm-9">
                            <a href="{{route('admin-class-result', $class->id)}}"><h3 class="subject_name">[{{$class->class_code}}] {{$class->name}}</h3></a>
                        </div>
                    </div>
                    <br>
                @endforeach
